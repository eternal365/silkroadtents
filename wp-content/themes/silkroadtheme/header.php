	...
	<script type="application/ld+json">
		{
			...
			"@type": "LocalBusiness",
			"image": ["https://silkroadtents.com/wp-content/uploads/2018/12/cropped-srt-fav-270x270.jpg"],
        ...
        <div class="col-5 text-left text-white">
          <ul class="icons unstyled nav-pills pl-0">
            <?php if ($url = of_get_option('facebook_adr')): ?>
              <li><a href="<?php echo $url; ?>" target="_blank" rel="nofollow"><i class="fa fa-facebook-official fa-2x"></i></a></li>
            <?php endif; ?>
            <?php if ($url = of_get_option('instagram_adr')): ?>
              <li><a href="<?php echo $url; ?>" target="_blank" rel="nofollow"><i class="fa fa-instagram fa-2x"></i></a></li>
            <?php endif; ?>
            <?php if ($url = of_get_option('pinterest_adr')): ?>
              <li><a href="<?php echo $url; ?>" target="_blank" rel="nofollow"><i class="fa fa-pinterest-square fa-2x"></i></a></li>
            <?php endif; ?>
          </ul>
        </div>
  ...
  <nav class="navbar navbar-expand-lg sticky-top p-0">
    <div class="container">
      ...
      <div class="collapse navbar-collapse nav" id="navbar">
        <?php wp_nav_menu( array('menu' => 'main-menu',  'menu_class' => 'navbar-nav justify-content-between','container' => false, 'walker'  => new wp_bootstrap_navwalker()) ); ?>
      </div>
    </div>
  </nav>