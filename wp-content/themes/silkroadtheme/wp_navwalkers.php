...
// Bootstrap Sidebar Nav with accordian functionality
  ...
  class wp_sidebar_navwalker extends Walker_Nav_Menu {
           ...
           function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
               ...
               /*if ( $item->is_dropdown && $depth === 0 ) {
                   ...
                   //$item_html = str_replace( '</a>', '  <i class="fa fa-chevron-down pull-right"></i></a>', $item_html );
               }*/
               
               if ( $item->is_dropdown && $depth === 0 ) {
                   //$item_html = str_replace( '<a', '<a class="dropdown-toggle"',$item_html);
                   //$item_html = str_replace( '</a>', '</a> <span class="caret-wrapper" data-toggle="dropdown"><span class="fa fa-angle-down" aria-hidden="true"></span></span>', $item_html );
