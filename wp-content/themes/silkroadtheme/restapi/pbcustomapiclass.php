...
class WP_REST_MultiplePostType_Controller extends WP_REST_Controller
{
    ...
    {
        $this->version   = '2';
        $this->namespace = 'pb/v' . $this->version;
    ...
    public function get_items($request)
    {
        ...
        $request['search'] = implode ( ' ', explode ( "+", $request['search'] ) );
        ...
        //$args['post_type']           = array('news','post','event','page');
        ...
        if (isset($request['compare'])) {
           ...
           $args['meta_query'] = array();
            ...
            if (isset($request['meta_key'])) {
                $args['meta_query'][0]['key'] = $request['meta_key'];
            }

            if (isset($request['meta_value'])) {
                $args['meta_query'][0]['value'] = $request['meta_value'];
                
            }

            if (isset($request['compare'])) {
                $args['meta_query'][0]['compare'] = $request['compare'];
        ...
        if ( $request['search'] !="") {
            ...
            //$query_args['post_type']           = array('news','post','event','page');
            $query_args['post_type']           = $request['type'];
            $query_args['post_parent']         = $request['post_parent'];
            ...
            */
            ...
            /*
                ...
                $query_args['_meta_or_title'] = $request['search']; //not using 's' anymore
