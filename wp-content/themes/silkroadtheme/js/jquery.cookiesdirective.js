...
;(function($) {
  ...
  var disclosure = function(options) {
    ...
    if(settings.explicitConsent) {
      ...
      html += '<div style="margin-top:5px;"><input class="btn btn-primary" type="submit" name="impliedsubmit" id="impliedsubmit" value="Do not show this message again"/></div></div>'; 
    }   
    html += '</div></div>';
    $('body').append(html);
