...
<?php get_header(); ?>
	...
	<div class="header-image-wrapper">	
		<div class="header-image" style="background: url('<?php echo $backgroundImg[0]; ?>') no-repeat center bottom; background-size: cover;">	
		</div><!-- header image -->
		<div class="container">
			<?php
										...
										<div class="col-12 my-6">
											...
											<div class="collapse" id="collapse-<?php echo $post->ID; ?>">
												<div class="card card-body">
														...
														if( $images ): ?>
															<div class="row">
																<?php foreach( $images as $image ): ?>
																	<div class="col-12 col-sm-4 text-center my-2">
													...
													<?php endif; ?>
													<hr>
													<a href="<?php the_permalink(); ?>" class="btn btn-primary btn-lg btn-block">View More</a>
												</div>
											</div>
										</div>
									</div> 
